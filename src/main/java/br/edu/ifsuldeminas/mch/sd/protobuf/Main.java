...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Arquivo Protobuf gerado: " + FILE_NAME);

            Person recovered = new Reader().read(FILE_NAME);
            System.out.println("Objeto recuperado via Protobuf:");
            System.out.println(recovered);
            System.out.println(recovered.getAddress());
        } catch (IOException e) {
            System.out.println("Erro ao processar arquivo Protobuf.");
            e.printStackTrace();
        }
    }
}
